...
async def generate_tts_runtime(request: dict = Body(...)):
    """
    Always generate TTS (Google Text-to-Speech) in real-time.
    ...
    try:
        ...
        logger.info(f"🎙️ Generating runtime TTS for: {text[:60]}")
